...
@Component({
    selector: 'app-video-busuness-statistics',
    templateUrl: './busuness-statistics.html',
    styleUrls: ['./busuness-statistics.scss']
})
export class VideoBusunessStatisticsComponent implements OnInit {
    ...
    getData() {
        ...
        this.http.get("mix/video/admin/member/business-statistical", params).then(ret => {
            let headers = [{ label: "科目", key: "from", }];
